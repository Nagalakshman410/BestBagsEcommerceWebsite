...
async function seedDB() {
  ...
  // ];
  // const Tshirts_imgs = [
  //   "https://ibb.co/gjSvqdm",
  //   "https://ibb.co/jfts9X7",
  //   "https://ibb.co/wNR7jZs",
  //   "https://ibb.co/vshhSFY",
  //   "https://ibb.co/cvKnYJg",
  //   "https://ibb.co/VVWbCry",
  //   "https://ibb.co/GcXS70T",
  //   "https://ibb.co/QFLWjB7",
  //   "https://ibb.co/JzV4ch6",
  //   "https://ibb.co/8X7kj7Q",
  // ];
  ...
  // await seedProducts(Tshirts_titles,Tshirts_imgs, "T-shirts");
  // await seedProducts(hoddies_titles,hoodies_imgs, "Hoodies");
  await seedProducts(travel_titles, travel_imgs, "Travel");
  await seedProducts(mugs_titles,mugs_imgs, "mugs");
  // await seedProducts(
